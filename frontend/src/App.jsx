            ...
            {messages.length === 0 && (
              <div className="text-center py-16">
                ...
                <div className="mt-8 p-4 bg-slate-50 dark:bg-slate-800/50 rounded-xl max-w-md mx-auto">
                  <p className="text-sm font-medium text-slate-700 dark:text-slate-300 mb-2">💡 Try these examples:</p>
                  <div className="space-y-2">
                    <button 
                      onClick={() => setInput("What's the weather like in Madrid?")}
                      className="w-full text-left px-3 py-2 text-sm bg-white dark:bg-slate-800 rounded-lg hover:bg-slate-100 dark:hover:bg-slate-700 transition-colors"
                    >
                ...
                <div className="mt-2 pl-12 max-w-[75%]">
                  <div className="flex flex-wrap gap-2">
                    {msg.logs.map((log, logIdx) => {
                      // Determinar estilo basado en contenido
                      let icon = '🔧';
